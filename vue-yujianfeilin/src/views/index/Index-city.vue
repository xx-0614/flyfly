...
<style scoped>
    ...
    .cover span i{
        ...
        width:30px;
        height:30px;
        background:url(../../assets/img/index/iconq11.png) center center no-repeat;
